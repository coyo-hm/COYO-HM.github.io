...
<div style={{display: "flex", gap: "16px", alignItems: "flex-start", margin: "20px 0"}}>
  <img src={"https://user-images.githubusercontent.com/56423604/265755786-058d9ad6-8657-4463-9ae4-dc23910f97ac.png"} alt={"yarn-berry-pnp-size-node-modules"} width={"50%"}/>
  <img src={"https://user-images.githubusercontent.com/56423604/265755151-a51207d8-76ea-41b7-9f8d-b978bd005915.png"} alt={"yarn-berry-pnp-size-cache"} width={"50%"}/>
</div>
