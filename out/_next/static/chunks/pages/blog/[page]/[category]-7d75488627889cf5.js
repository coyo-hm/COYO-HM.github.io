(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [66],
  {
      ...
      let c = (e) => {
        ...
        n = (e) => {
          let {
            ...
            x = new Date(n || c).toISOString(),
            g = b.map((e) => ({ url: e, alt: t }));
    ...
    9106: function (e, t, r) {
      ...
      var a = r(5893),
        l = r(7294);
      let o = { list: 5, card: 12 },
        c = (e, t, r) => {
          let a = Math.max(1, Math.ceil(e / o[r])),
            [c, n] = (0, l.useState)(0),
            [s, i] = (0, l.useState)(0);
          return (
            (0, l.useEffect)(() => {
            ...
            { lastPage: a, startPage: c, endPage: s }
          );
        };
      var n = r(1664),
        s = r.n(n),
        i = r(1649);
      let b = (e) => {
        let { currPage: t, startPage: r, endPage: l, category: o, menu: c } = e,
          n = (e) => "/".concat(c, "/").concat(e, "/").concat(o);
        return (0, a.jsxs)("div", {
          className: "flex text-blue-700 justify-center items-center my-5",
          children: [
            (0, a.jsx)(s(), {
              href: n(t - 1),
              className: "hover:text-blue-900",
              onClick: (e) => r === t && e.preventDefault(),
              children: (0, a.jsx)(i.u1R, {}),
            }),
            (0, a.jsx)("div", {
              className:
                "flex gap-3 items-center justify-center mx-2 text-base",
              children: Array(l - r)
                .fill(0)
                .map((e, l) =>
                  (0, a.jsx)(
                    s(),
                    {
                      href: n(l + r),
                      className:
                        "hover:text-blue-900 flex items-center justify-center ".concat(
                          l + r === t
            ...
            (0, a.jsx)(s(), {
              className: "hover:text-blue-900",
              href: n(t + 1),
              onClick: (e) => l === t + 1 && e.preventDefault(),
              children: (0, a.jsx)(i.hjJ, {}),
            }),
          ],
        });
      };
      ...
      let u = (e) => {
        ...
        return (0, a.jsxs)(s(), {
          className:
            "grid grid-cols-[1fr_3fr] bg-[rgb(255,255,255,0.6)] dark:bg-[rgba(255,250,250,0.1)] rounded shadow-xl bg-translate overflow-hidden hover:-translate-y-0.5 hover:duration-300 hover:ease-in-out",
          href: "/".concat(c),
          children: [
            (0, a.jsx)("div", {
              className: "relative",
              children: n
                ...
                : (0, a.jsx)("div", {
                    className:
                      "h-full w-full bg-[rgb(255,255,255,0.8)] dark:bg-[rgb(255,255,255,0.1)]",
                  }),
            }),
            (0, a.jsxs)("section", {
              className: "flex flex-col p-4 min-h-[130px]",
              children: [
                (0, a.jsx)("div", {
                  className:
                    "text-neutral-800 dark:text-neutral-100 font-semibold pb-2",
                  children: t,
                }),
                (0, a.jsxs)("div", {
                  className:
                    "dark:text-neutral-300 mb-2 w-full max-h-10 break-normal overflow-hidden text-ellipsis flex items-center",
                  children: [
                    (0, a.jsxs)("span", {
                    ...
                    (0, a.jsx)("div", {
                      className:
                        "flex items-center gap-1 flex-shrink flex-grow border-l-2 border-neutral-200 overflow-hidden pl-2 ml-2",
                      children: l.map((e) => (0, a.jsx)(g.Z, { tag: e }, e)),
                    }),
                  ],
                }),
                !!o &&
                  (0, a.jsx)("div", {
                    className:
                      "text-neutral-600 dark:text-neutral-300 break-normal text-ellipsis text-xs",
                    children: o,
                  }),
              ],
            }),
            ...
            "list" === t &&
              (0, a.jsx)("article", {
                ...
                children: r.map((e) => {
                  ...
                  return (0, l.createElement)(u, { ...t, slug: r, key: r });
                }),
              }),
            "card" === t &&
              (0, a.jsx)("article", {
                ...
                children: r.map((e) => {
                  ...
                  return (0, l.createElement)(f.Z, { ...t, slug: r, key: r });
                }),
              }),
            (0, a.jsx)(b, {
              currPage: o,
    ...
    9576: function (e, t, r) {
      ...
      let n = (e) => {
        var t;
        let { posts: r, allTags: n, category: s, page: i } = e,
          b =
            (null ===
              (t = n.find((e) => {
                let { tag: t } = e;
          ...
          children: [
            ...
            (0, a.jsx)(c.Z, {
              ...
              children: (0, a.jsxs)("header", {
                className: "flex justify-end items-center gap-1 px-1",
                children: [
                  (0, a.jsx)("h1", {
  ...
  function (e) {
    e.O(0, [866, 130, 774, 888, 179], function () {
      return e((e.s = 5939));
    }),
      (_N_E = e.O());
  },
